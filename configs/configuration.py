...
def parser_args():
    ...
    parser.add_argument('--model-path', type=str,
                        help='the path where the model trained in stage1 is saved in')
    parser.add_argument('--gpu', default=1, type=int,
                        help='gpu number')
    ### meta val setting
    parser.add_argument('--meta-val-iter', type=int, default=600,
    ...
    ### meta test setting
    parser.add_argument('--meta-test-iter', type=int, default=600,
                        help='number of iterations for meta val')
    parser.add_argument('--meta-test-way', type=int, default=5,
                        help='number of ways for meta val')
    parser.add_argument('--meta-test-shot', type=int, default=5,
                        help='number of shots for meta val')
    parser.add_argument('--meta-test-query', type=int, default=15,
                        help='number of queries for meta val')
    parser.add_argument('--meta-test-metric', type=str, choices=('euclidean', 'cosine', 'l1', 'l2'),
                        default='euclidean',
                        help='meta-test evaluate metric')
    ### others
    ...
    parser.add_argument('--seed', default=0, type=int,#112
                        help='seed for initializing training. ')#10 2 9
    parser.add_argument('--disable-tqdm', action='store_true',
                        help='disable tqdm.')
    parser.add_argument('--print-freq', '-p', default=12, type=int,
    ...
    ### openset
    parser.add_argument('--do-open', default=True, type=bool,
                        help='whether to solve the open-set problem')
    parser.add_argument('--train-oway', default=5, type=int,
                        help='number of ways for open episode') 
    parser.add_argument('--train-oshot', default=5, type=int,
                        help='number of shots for open episode')     
    parser.add_argument('--train-oquery', default=15, type=int,
                        help='number of queries for open episode')       
    parser.add_argument('--val-oway', default=5, type=int,
                        help='number of ways for open episode') 
    parser.add_argument('--val-oshot', default=5, type=int,
                        help='number of shots for open episode')     
    parser.add_argument('--val-oquery', default=15, type=int,
                        help='number of queries for open episode')   
    parser.add_argument('--test-oway', default=5, type=int,
                        help='number of ways for open episode') 
    parser.add_argument('--test-oshot', default=5, type=int,
                        help='number of shots for open episode')     
    parser.add_argument('--test-oquery', default=15, type=int,
                        help='number of queries for open episode')      
    parser.add_argument('--scale-cls', default=1, type=int,
                        help='the parameter used in the cosine similarity')
    parser.add_argument('--out-dim', default=512, type=int,
                        help='the output feature dim of feature extractor')
    parser.add_argument('--weight-generator-type', default='attention_based', type=str,
                        help='classifier method')
    parser.add_argument('--classifier-type', default='cosine', type=str,
